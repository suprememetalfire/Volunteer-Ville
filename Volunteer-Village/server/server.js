...
this.engine.network.registerCommand('moveminiBus', this.bind(this.moveminiBus));
		...
		this.aryTaskIcons[2] = [ 'taskIcon', 19, 32, 'townMap' ];	
		this.aryTaskIcons[3] = [ 'taskIcon', 5, 5, 'townMap' ];
		this.aryTaskIcons[4] = [ 'taskIcon', 12, 5, 'charityMap' ];
		...
		this.aryTaskIcons[12] = [ 'taskIcon', 25, 23, 'hospitalMap' ];
		this.aryTaskIcons[13] = [ 'taskIcon', 12, 3, 'townMap' ];
		this.aryTaskIcons[14] = [ 'taskIcon', 45, 20, 'townMap' ];
		this.aryTaskIcons[15] = [ 'taskIcon', 4, -14, 'mealsMap' ];
		...
		this.aryTaskIcons[21] = [ 'taskIcon', 11, 5, 'schoolMap' ];
	...
	taskZeroPartTwo: function( val, client )
	{
		var entity = this.engine.entities.read( 'woman' + client.sessionId );
		var num = client.sessionId;
		...
		{
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'womanWalkBig', -7, 5, 'schoolMap');
			this.intAnimationCounter = 10;
			this.engine.network.send( 'taskStageZero', 1, num );
	...
	taskSevenPartTwo: function( val, client )
	{
		...
		if( entity.map_id == 'townMap' && ( entity.entity_x == 39 && entity.entity_y == 19 ) && this.intAnimationCounter == 10 )
		{
			this.destroyTaskObjects( 'taskIcon' + num );
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'wMRepairs', 39, 19, 'townMap');
			this.intAnimationCounter = 0;
		}
		...
		{
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'womanWalk', 39, 19, 'townMap');
			this.intAnimationCounter = 10;
	...
	taskTenPartTwo: function( val, client )
	{
		...
		if( entity.map_id == 'hospitalMap' && ( entity.entity_x == 19 && entity.entity_y == 32 ) && this.intAnimationCounter == 10 )
		{
			this.destroyTaskObjects( 'taskIcon' + num );
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'wMHBed', 16, 29, 'hospitalMap');
			this.intAnimationCounter = 0;
		}
		...
		{
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'womanWalkBig', 19, 32, 'hospitalMap');
			this.intAnimationCounter = 10;
	...
	taskFourteenPartTwo: function( val, client )
	{
		...
		{
			this.destroyTaskObjects( 'bag' + num );
			this.createTaskIcons( 15, num );			
	...
	taskSeventeenPartTwo: function( val, client )
	{
		...
		if( entity.map_id == 'oldFolksHomeMap' && ( entity.entity_x == -6 && entity.entity_y == -7 ) && this.intAnimationCounter == 10 )
		{	
			this.destroyTaskObjects( 'taskIcon' + num );
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'wMHBed', -6, -7, 'oldFolksHomeMap');
			this.intAnimationCounter = 0;
		}
		...
		{
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'womanWalkBig', -6, -7, 'oldFolksHomeMap');
			this.intAnimationCounter = 10;
	...
	taskTwentyFourPartTwo: function( val, client )
	{
		...
		if( entity.map_id == 'schoolMap' && ( entity.entity_x == 11 && entity.entity_y == 5 ) && this.intAnimationCounter == 10 )
		{	
			this.destroyTaskObjects( 'taskIcon' + num );
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'wMArt', 11, 5, 'schoolMap');
			this.intAnimationCounter = 0;
		}
		...
		{
			this.engine.entities.remove( entity );
			this.createNewMapAvatar(num, 'womanWalkBig', 11, 5, 'schoolMap');
			this.intAnimationCounter = 10;
	...
	taskTwentySevenPartOne: function( val, client )
	{
		var entity = this.engine.entities.read( 'woman' + client.sessionId );
		var num = client.sessionId;
	...
	taskTwentySevenPartTwo: function( val, client )
	{
		var entity = this.engine.entities.read( 'woman' + client.sessionId );
		var num = client.sessionId;
	...
	createTaskIcons: function( num, id )
	{
		this.engine.entities.create
		({
			template_id: this.aryTaskIcons[num][0],
			entity_x: this.aryTaskIcons[num][1],
			entity_y: this.aryTaskIcons[num][2],
			entity_id: this.aryTaskIcons[num][0] + id,
			entity_locale: LOCALE_EVERYWHERE + LOCALE_DB,
			map_id: this.aryTaskIcons[num][3],
		});
	},
	...
	switchMap: function( data, client )
	{
		...
		if( entity.map_id == 'townMap' )
		{
			...
			{	
				this.engine.entities.remove( entity);
				this.createNewMapAvatar(num, 'womanWalkBig', 3, 20, 'schoolMap');
		...
		// Inside to Outside.
		if (entity.entity_x == 3 && entity.entity_y == 21 && entity.map_id =='schoolMap' )
		{
			this.engine.entities.remove( entity);
