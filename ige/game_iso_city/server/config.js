...
this.dir_game = this.dir_game_root;
	...
	dir_game_root:'/game_iso_city', // The sub-folder inside the root where the game files are located
	dir_game_client:'/game_iso_city/client', // The sub-folder inside the root where the client game files are located
	dir_game_server:'/game_iso_city/server', // The sub-folder inside the root where the server game files are located
