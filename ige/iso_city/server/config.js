...
igeConfig = {
	...
	dir_game_root:'/iso_city', // The sub-folder inside the root where the game files are located
	dir_game_client:'/iso_city/client', // The sub-folder inside the root where the client game files are located
	dir_game_server:'/iso_city/server', // The sub-folder inside the root where the server game files are located
