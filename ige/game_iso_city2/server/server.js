...
//this.engine.viewports.setCamera(this.engine.viewports.viewport_name(viewP), 'sCamera');
//this.engine.cameras.lookAt(this.engine.cameras.camera_name(mainCamera), 100,100,100);
		}
	},
	...
	enterBuilding: function( data, client )
	{
		...
		{
			this.engine.entities.moveToTile( entity, 106, 46, false );			
			//this.log(client.sessionId + ' True');
		}
		else
		{
