...
igeConfig = {
	...
	///////////////////////////////////////////////////////////////////////////////////////
	igeLicense: {
		accountId:'290ngn20fj32rr',
		accountChallenge:'20489hg03n0329n439bng'
	},
	...
	mode:'release', // Server mode - either 'debug' or 'release'. In debug mode, client scripts are not obfuscated.
	...
	dir_game_root:'/game_2d_space', // The sub-folder inside the root where the game files are located
	dir_game_client:'/game_2d_space/client', // The sub-folder inside the root where the client game files are located
	dir_game_server:'/game_2d_space/server', // The sub-folder inside the root where the server game files are located
